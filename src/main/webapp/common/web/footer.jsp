				...
				<div
					...
					<a href="index.html" class="navbar-brand">
						<h1 class="m-0 text-white">
							...
							<img style="max-width: 100 px; max-height: 50px;" src="<c:url value="/templates/web/img/logo-no-background.png"/>">
						
						</h1>
					</a>
					<p class="mt-3 mb-4">make big things from small things</p>
					<form action="">
