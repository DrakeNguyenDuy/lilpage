...
<div class="container-fluid position-relative p-0">
	<nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
		<a href="index.html" class="navbar-brand p-0">
			<h1 class="m-0">
				<img style="max-width: 150 px; max-height: 80px;"
					src="<c:url value="/templates/web/img/logo-black.png"/>" />
			</h1>
		</a>
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			<div class="navbar-nav ms-auto py-0">
				<a href="<c:url value="/home"/>" class="nav-item nav-link active">Home</a> <a
					href="<c:url value="/about-us"/>" class="nav-item nav-link">About</a>
				<a href="<c:url value="/service"/>" class="nav-item nav-link">Services</a>
				<div class="nav-item dropdown">
					<a href="<c:url value="/blogs"/>" class="nav-item nav-link"
						>Blog</a> 
						<!-- <a
						href="<c:url value="/blogs"/>" class="nav-link dropdown-toggle"
						data-bs-toggle="dropdown">Blog</a>
					<div class="dropdown-menu m-0">
						<a href="<c:url value="/blogs"/>" class="dropdown-item">Blog
							Grid</a> <a href="detail.html" class="dropdown-item">Blog Detail</a>
					</div> -->
				</div>
				<!--<div class="nav-item dropdown">
			...
			<a href="<c:url value="/about-us"/>"
				class="btn btn-primary py-2 px-4 ms-3">Contact us</a>
		</div>
	</nav>
</div>
<!-- Navbar & Carousel End -->
